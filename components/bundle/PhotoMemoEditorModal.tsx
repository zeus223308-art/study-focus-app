...
import { useWidthFitImageLayout, WidthFitPreviewImage } from '@/components/ui/WidthFitPreviewImage';
...
export function PhotoMemoEditorModal({
  ...
  const { imgW, imgH } = useWidthFitImageLayout(displayUri, viewerW, viewerH);
              ...
              overlay={({ width, height }) => (
                <>
                  <AnnotationCanvas
                    ...
                    height={height}
                    style={[styles.ink, { width, height }, !inkInteractive && styles.inkPassthrough]}
                  />
                  {editingText ? (
